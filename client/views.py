...
class CreateProfileClient(LoginRequiredMixin, FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data_value = data_value.year.__str__() + data_value.month.__str__() + data_value.day.__str__() + data_value.hour.__str__() + data_value.minute.__str__() + data_value.second.__str__()
        context["default_document_number_value"] = data_value
        return context
